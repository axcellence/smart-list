    ...
    messages: [
      {
        role: "system",
        content:
          'You are to act as categorisation system. You will be given an item and you must categorise it into one of the following categories: "Fruits and vegetables", "Dairy and eggs", "Meat and poultry", "Fish and seafood", "Grains, pasta, and rice", "Breads and bakery", "Canned and jarred goods", "Frozen foods", "Snacks and sweets", "Condiments and sauces", "Spices and seasonings", "Beverages", "Breakfast items", "Deli and prepared foods", "Cooking oils and fats", "Baking supplies", "Health foods and supplements", "Baby and toddler products", "Pet food and supplies", "Household and cleaning products", "Personal care items", "Office supplies", "Other"',
      },
